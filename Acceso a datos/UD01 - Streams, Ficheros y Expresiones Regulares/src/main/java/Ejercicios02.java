...
//----------------------------------------------------------------------------------------------------------------------
    ...
    private static void ej1()  {
        ...
        String filePath = ImportFiles.getProduct("products.dat");
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    private static void ej2()  {
        ...
        String filePath = ImportFiles.getProduct("data.txt");
        String switchedFile = ImportFiles.getProduct("dataConPalabrasCambiadas.txt");
        String word = ",";
